...
//     version 1.11.0
//     from Assets/Scripts/Controller/PlayerControllerAction.inputactions
//
...
public partial class @PlayerControllerAction: IInputActionCollection2, IDisposable
{
    ...
    {
        UnityEngine.Debug.Assert(!m_InLevel.enabled, "This will cause a leak and performance issues, PlayerControllerAction.InLevel.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerControllerAction.UI.Disable() has not been called.");
    }
