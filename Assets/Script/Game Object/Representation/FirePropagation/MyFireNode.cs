...
public class MyFireNode : MonoBehaviour
{
    ...
    [SerializeField] private float m_combustionRateValue=1.0f;
    /// <summary>
    /// Yangın yeni(şimdi) başladı. <br> Not: Yangını başlatan değişken budur. </br>
    /// </summary>
    [SerializeField] public bool m_fireJustStarted = false;
    /// <summary>
    /// Yanıyor mu?
    /// </summary>
    [SerializeField] private bool m_isAlight = false;
    /// <summary>
    /// Yangın sönmüş
    /// </summary>
